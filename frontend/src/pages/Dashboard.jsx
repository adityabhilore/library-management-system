    ...
    async function fetchAll() {
      try {
        const [sRes, cRes, pieRes, barRes, timelineRes] = await Promise.all([
          ...
          axios.get("http://127.0.0.1:8000/admin/charts/members"),
          axios.get("http://127.0.0.1:8000/admin/charts/department-wise"),
          axios.get("http://127.0.0.1:8000/admin/charts/attendance-timeline", {
            params: {
